...
- `cmd/bees` — cobra CLI (`init`, `run`, `tick`, `exec`, `status`, `cost`, `kill`, `mail`, `notes`, `issue`, `done`, `mcp`, `doctor`, `config`, `skills`, `prompts`, `labels`, `templates`, `version`).
