...
type Brief[R Reference] struct {
	// Ref identifies the change under review; Title and Author are supplied
	// by the caller. All three come from the bundle.
	Ref    R      `json:"ref"`
...
func WriteBrief[R Reference](dir string, b *Brief[R]) error {
...
func ReadBrief[R Reference](dir string) (*Brief[R], error) {
