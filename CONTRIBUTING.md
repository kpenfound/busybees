...
internal/review/     bees review: two configuration files, the context gathered for a pull request, the distiller session that briefs the review, the angle sessions that review from it, the judge that merges their findings, the artifact directory a review is kept in
