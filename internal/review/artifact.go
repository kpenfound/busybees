...
// tools can reach, for them to search; the diff itself is in every angle's
// prompt. It is not written when the angles ran in the machine's own
// checkout instead (Angles.Dir): a review does not write into a working
