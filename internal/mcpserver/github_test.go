...
func TestGitHubToolsPerRole(t *testing.T) {
	...
	for role, want := range map[string]string{
		...
		config.RoleReviewer:  "comment, done, issue_create, issue_link, issue_view, mail_list, mail_send, notes_read, notes_write, pr_view, report_factory_error, submit_review",
		config.RoleQA: "comment, done, file_bug, issue_create, issue_link, issue_view, mail_list, " +
			"mail_send, notes_read, notes_write, pr_view, report_factory_error",
