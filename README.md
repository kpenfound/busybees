...
into feature issues, replies on it, and closes it when done. A concrete bug can skip all
that: `bees` + `bees:bug` goes straight to triage. Milestones stay yours: bees never
